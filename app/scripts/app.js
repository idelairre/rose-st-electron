...
bootstrap(MainComponent, ['ngAnimate', 'ngMessages', 'ngMaterial', 'tc.chartjs', 'ui.router', AuthenticationConfig.name, EventConfig.name, HttpInterceptor.name, RouteConfig.name, MdThemeConfig.name]);
